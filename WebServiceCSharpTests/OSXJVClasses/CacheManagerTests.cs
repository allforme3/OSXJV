...
namespace OSXJV.Classes.Tests
{
	...
	public class CacheManagerTests
	{
		...
		[Test]
		public void TestCacheManagerManageCacheSetupCorrect()
		{
			Console.WriteLine("TestCacheManagerManageCache");
			string arg = "";
			...
			if (!Directory.Exists(arg))
				Directory.CreateDirectory(arg);
			CacheManager.Setup(arg);
			Assert.DoesNotThrow(() => CacheManager.ManageCache());
			CacheManager.Close();
		}

		[Test]
		public void TestCacheManagerManageCacheNotSetupCorrect()
		{
			Console.WriteLine("TestCacheManagerManageCacheNotSetupCorrect");
			Assert.Throws<Exception>(() => CacheManager.ManageCache());
		}
	}
}