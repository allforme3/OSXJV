...
<head>
    <meta charset="utf-8">
    <title>XML File Uploading</title>
...
<body>
    ...
    <div class="container" role="main">
        <form method="post" action="XMLProcesses.php" enctype="multipart/form-data" novalidate class="box">
                    ...
                    if( isAdvancedUpload ) // ajax file upload for modern browsers
                    {
                        ...
                        $.ajax(
                        {
                            ...
                            success: function( data )
                            {
                                ...
                                if (data.success) { $("#result").html(data.data); }
